...
const MyCourses = lazy(() =>
  import('./pages/dashboard/MyCourses').then((m) => ({ default: m.MyCourses }))
);
...
const Gamification = lazy(() =>
  import('./pages/Gamification').then((m) => ({ default: m.Gamification }))
);
...
const StudyGroups = lazy(() =>
  import('./pages/StudyGroups').then((m) => ({ default: m.StudyGroups }))
);
...
const InstructorLayout = lazy(() =>
  import('./components/InstructorLayout').then((m) => ({ default: m.InstructorLayout }))
);
const Practice = lazy(() => import('./pages/Practice').then((m) => ({ default: m.Practice })));
const VoicePractice = lazy(() =>
  import('./pages/VoicePractice').then((m) => ({ default: m.VoicePractice }))
);
const Recommendations = lazy(() =>
  import('./pages/Recommendations').then((m) => ({ default: m.Recommendations }))
);
const LearningHistory = lazy(() =>
  import('./pages/LearningHistory').then((m) => ({ default: m.LearningHistory }))
);
...
const AdminCourses = lazy(() =>
  import('./pages/admin/AdminCourses').then((m) => ({ default: m.AdminCourses }))
);
...
const AdminInstructors = lazy(() =>
  import('./pages/admin/AdminInstructors').then((m) => ({ default: m.AdminInstructors }))
);
const AdminCourseApproval = lazy(() =>
  import('./pages/admin/AdminCourseApproval').then((m) => ({ default: m.AdminCourseApproval }))
);
...
const Checkout = lazy(() =>
  import('./pages/payment/Checkout').then((m) => ({ default: m.default }))
);
